...
const routes = [
	...
	////////////////////////////////////////////////////
	{
		...
		name: 'ProductBuy',
		component: () =>
			import('@/components/product/Registration/RegistrationBuy.vue'),
	},
	{
		path: '/ProductRental',
		name: 'ProductRental',
		component: () =>
			import('@/components/product/Registration/RegistrationRental.vue'),
	},
	{
		path: '/ProductCamping',
		name: 'ProductCamping',
		component: () =>
			import('@/components/product/Registration/RegistrationCamping.vue'),
	},
	{
		...
		component: () =>
			import(
				'@/components/product/Registration/RegistrationCampingDetail.vue'
			),
	},
	/////////////////////////////////////////////////////////
	{
	...
	},
	{
		...
		component: () =>
			import('@/components/product/Buy/BuyProductDetail.vue'),
		props: true,
	},
	{
		path: '/BuyProductEdit',
	...
	////////////////////////////////////////////////////////////////
	{
		...
		component: () =>
			import('@/components/product/Rental/RentalProductList.vue'),
	},
	{
		path: '/RentalProductDetail/:rentalId',
		name: 'RentalProductDetail',
		component: () =>
			import('@/components/product/Rental/RentalProductDetail.vue'),
		props: true,
	},
	{
		...
		component: () =>
			import('@/components/product/Rental/RentalProductEdit.vue'),
		props: true,
	},
	///////////////////////////////////////////////////////////////////
	{
		...
		component: () =>
			import('@/components/product/Camping/CampingProductList.vue'),
	},
	{
		path: '/CampingProductDetail/:campingId',
		name: 'CampingProductDetail',
		component: () =>
			import('@/components/product/Camping/CampingProductDetail.vue'),
		props: true,
	},
	{
		...
		component: () =>
			import('@/components/product/Camping/CampingProductEdit.vue'),
		props: true,
	},
	///////////////////////////////////////////////////////////////////
	{
		...
		component: () =>
			import('@/components/product/Room/RoomProductList.vue'),
		props: true,
	},
	{
		...
		component: () =>
			import('@/components/product/Room/RoomProductDetail.vue'),
		props: true,
	},
	{
		...
		component: () =>
			import('@/components/product/Room/RoomProductEdit.vue'),
		props: true,
	},
	{
		...
		component: () =>
			import('@/components/product/Room/RoomProductCreate.vue'),
		props: true,
	},
	///////////////////////////////////////////////////////////////////
		...
		children: [
			{
				...
				name: 'storage',
				component: () =>
					import('@/views/admin/storage/StorageView.vue'),
			},
			{
				path: '/storageAdmin/manager',
				name: 'manager',
				component: () =>
					import('@/views/admin/manager/StorageManagerView.vue'),
			},
		],
	},
	{
